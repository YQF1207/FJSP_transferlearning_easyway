...
class GA:
    ...
    def main(self, Processing_time, J, M_num, J_num, O_num, iteration, factory_num, transfer, assignment,useless_job):
        ...
        #if exchange ==False:
        d.Gantt(d.Machines, iteration, factory_num,assignment,useless_job)
