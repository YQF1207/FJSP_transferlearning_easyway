...
from Encode_for_FJSP_constrast import Encode_contrast
import itertools
...
class GA_contrast:
    ...
    def main_contrast(self, Processing_time, J, M_num, J_num, O_num):
        e = Encode_contrast(Processing_time, self.Pop_size, J, J_num, M_num)
        OS_List = e.OS_List()
        ...
        #np.savetxt('transfer_CHS.txt',transfer_CHS,fmt='%d')
        print("contrast_end")
        ...
        # plt.close()
        return Best_fit,best_fit_each

if __name__=='__main__':
    from Instance_8 import Processing_time, J, M_num, J_num, O_num
    g = GA_contrast()
    g.main_contrast(Processing_time, J, M_num, J_num, O_num)